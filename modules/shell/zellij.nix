...
#
{
  ...
  rgbToTriplet = s: builtins.replaceStrings [", "] [" "] s;
  themeName = "fantasy-night";
  themeDir = "/home/${vars.user}/.config/zellij/themes";
in {
  environment = {
      ...
      file = {
        ".config/zellij/config.kdl" = {
          text = ''
            ...
            // Default value: true
            //
            show_statup_tips false
          '';
        };

        ".config/zellij/themes/${themeName}.kdl" = {
          text = let
            rgb = colors.colors.rgb;
          in ''
            themes {
            	${themeName} {
            		fg ${rgbToTriplet rgb.fg}
            		bg ${rgbToTriplet rgb.bg}
            		red ${rgbToTriplet rgb.red}
            		orange ${rgbToTriplet rgb.orange}
            		yellow ${rgbToTriplet rgb.yellow}
            		green ${rgbToTriplet rgb.green}
            		cyan ${rgbToTriplet rgb.cyan}
            		blue ${rgbToTriplet rgb.blue}
            		magenta ${rgbToTriplet rgb.purple}
            		white ${rgbToTriplet rgb.white}
            		black ${rgbToTriplet rgb.black}
            	}
            }
          '';
        };
